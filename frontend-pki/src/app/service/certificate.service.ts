...
export class CertificateService {
  ...
  private readonly userPath = 'https://localhost:9000/api/certificate';
  ...
  findIssuerEmailBySerialNumber(dto){
    return this._http.post('https://localhost:9000/api/certificate/findIssuerEmailBySerialNumber', dto, {responseType: 'text'})
  } 
